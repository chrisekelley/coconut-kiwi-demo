...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<p>\n    <a data-role=\"button\" id=\"FirstVisit\" class=\"btn btn-primary btn-lg\" href=\"#new/result/FirstVisit\">";
  stack1 = (helper = helpers.polyglot || (depth0 && depth0.polyglot),options={hash:{},data:data},helper ? helper.call(depth0, "FirstVisit", options) : helperMissing.call(depth0, "polyglot", "FirstVisit", options));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</a> &nbsp; <a data-role=\"button\" id=\"SecondVisit\" class=\"btn btn-primary btn-lg\" href=\"#new/result/SecondVisit\">";
  stack1 = (helper = helpers.polyglot || (depth0 && depth0.polyglot),options={hash:{},data:data},helper ? helper.call(depth0, "SecondVisit", options) : helperMissing.call(depth0, "polyglot", "SecondVisit", options));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</a>\n</p>\n<table id=\"records\">\n    <thead><tr>\n        <th>";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</a></li>\n            <li class=\"siteNav\" id=\"displayStatsLink\"><a href=\"#displayStats\">";
  stack1 = (helper = helpers.polyglot || (depth0 && depth0.polyglot),options={hash:{},data:data},helper ? helper.call(depth0, "displayStats", options) : helperMissing.call(depth0, "polyglot", "displayStats", options));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</a></li>\n        </ul>\n    </div><!--/.nav-collapse -->\n</div>\n";
  return buffer;
  });
...
this["JST"]["_attachments/templates/StatsItemView.handlebars"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
this["JST"]["_attachments/templates/StatsView.handlebars"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</legend>\n</div>\n\n<p>\n    <a data-role=\"button\" id=\"FirstVisit\" class=\"btn btn-primary btn-lg\">";
  stack1 = (helper = helpers.polyglot || (depth0 && depth0.polyglot),options={hash:{},data:data},helper ? helper.call(depth0, "FirstVisit", options) : helperMissing.call(depth0, "polyglot", "FirstVisit", options));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</a><br/>\n</p>\n<p>\n    <a data-role=\"button\" id=\"SecondVisit\" class=\"btn btn-primary btn-lg\">";
  stack1 = (helper = helpers.polyglot || (depth0 && depth0.polyglot),options={hash:{},data:data},helper ? helper.call(depth0, "SecondVisit", options) : helperMissing.call(depth0, "polyglot", "SecondVisit", options));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</a>\n</p>\n\n";
  return buffer;
